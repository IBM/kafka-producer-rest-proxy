...
class AndroidNotificationKafkaMessage extends KafkaMessage {
     ...
     */
    getPartition() {
        return  murmur.murmur2(this.notification.subscriptionNotification.purchaseToken, HASH_SEED) % this.partitions;
    }
...
module.exports = AndroidNotificationKafkaMessage;